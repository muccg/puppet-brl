...
##
  ...
  ##
    $CROSSMATCH_DIR = "<%= $destination_dir %>/bin";
  ...
  ##
    $HMMER_DIR   = "<%= $destination_dir %>/hmmer";
  ...
  ##
    $RMBLAST_DIR   = "<%= $destination_dir %>/rmblast";
  ...
  ##
    $WUBLAST_DIR   = "<%= $destination_dir %>/wublast";
...
##
  $TRF_PRGM = "<%= $destination_dir %>/bin/trf";
